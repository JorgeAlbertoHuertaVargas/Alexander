        ...
        if (resp.length != 0) {
            ...
            resp.forEach(valor => {
                template += `
                         ...
                         <td>
                          <button class='btn btn-info' onclick = 'EditarCorse(this)' style=' font-size:13px;Background:#616161'> <i class='fa fa-edit' style=' font-size:13px;'></button></i>&nbsp;
                         <button class='btn' onclick = 'EliminarCurso(this)' style=' font-size:13px; Background:#FF5722'> <i class='fa fa-trash'style=' font-size:13px;color:#FBF8EF'></button></i>
                         </td>
                         </tr>
                      `
                cont++;
